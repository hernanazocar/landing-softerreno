...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-[#0f172a] via-[#1d4ed8] to-[#1e40af]">
      {/* Header BLANCO con Logo e Isotipo REAL - EXTRA COMPACTO EN MOBILE */}
      <header className="bg-white border-b border-gray-200">
        <div className="container mx-auto px-4 py-1.5 md:px-6 md:py-2">
          <div className="flex items-center gap-2">
            <div className="w-8 h-8 md:w-10 md:h-10 bg-[#3b5bdb] rounded-lg md:rounded-xl flex items-center justify-center shadow-sm p-1">
              <Image
            ...
            <div>
              <h1 className="text-gray-900 font-bold text-sm md:text-base tracking-tight leading-tight">Softerreno</h1>
              <p className="text-gray-500 text-[8px] md:text-[10px] tracking-wider font-medium uppercase">ERP Inmobiliario</p>
            </div>
          </div>
        </div>
      </header>
      ...
      <section className="relative bg-gradient-to-br from-[#0f172a] via-[#1d4ed8] to-[#1e40af] py-3 md:py-4 overflow-hidden min-h-[calc(100vh-48px)] md:h-[calc(100vh-56px)]">
        ...
        <div className="container mx-auto px-4 md:px-6 relative z-10 h-full flex flex-col justify-start md:justify-center py-2 md:py-4">
          <div className="grid lg:grid-cols-[1fr_1.3fr] gap-4 md:gap-8 items-center max-w-7xl mx-auto">
            {/* Left Content */}
            <div>
              <div className="inline-flex items-center gap-1.5 md:gap-2 bg-white/5 backdrop-blur-sm px-2 py-1 md:px-4 md:py-2 rounded-full mb-2 md:mb-4 border border-white/20">
                <motion.span
                ...
                ></motion.span>
                <span className="text-white text-xs md:text-sm font-semibold">ERP #1 en Gestión de Loteos</span>
              </div>

              <h1 className="text-xl md:text-4xl lg:text-5xl font-bold text-white mb-1.5 md:mb-3 leading-tight">
                Vende más parcelas<br />
                con <span className="text-[#7c9de8]">gestión profesional</span>
              </h1>

              <p className="text-xs md:text-base text-blue-100 mb-1.5 md:mb-3 leading-snug md:leading-relaxed max-w-2xl">
                Controla proyectos, stock, clientes y cobranza en una plataforma
                diseñada específicamente para desarrolladores de lotes.
              </p>

              <p className="text-white text-sm md:text-lg font-bold mb-2 md:mb-4">
            ...
            {/* Right - Dashboard Preview con IMAGEN REAL - MUY PEQUEÑO EN MOBILE */}
            <div className="relative w-full lg:ml-auto lg:max-w-2xl lg:-mr-12 mt-3 lg:mt-0 max-w-sm mx-auto lg:max-w-2xl">
              ...
              <div className="relative rounded-lg md:rounded-xl shadow-2xl border border-white/30 md:border-2 backdrop-blur-sm p-0.5 md:p-1 bg-white/5">
                {/* Browser Chrome */}
                <div className="bg-[#3a3a3a] rounded-t-lg px-2 py-1 md:px-3 md:py-2 flex items-center gap-1 md:gap-2">
                  ...
                  <div className="flex-1 bg-[#2a2a2a] rounded px-1.5 py-0.5 md:px-2 md:py-1 text-gray-400 text-[10px] md:text-xs">
          ...
          {/* Beneficios debajo - Cards MUY COMPACTAS EN MOBILE */}
          <div className="mt-3 md:mt-8 max-w-6xl mx-auto">
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-1.5 md:gap-3">
              {[
                {
                ...
                <div key={i} className="flex items-center gap-1.5 md:gap-3 bg-white/10 backdrop-blur-md border border-white/30 rounded-md md:rounded-xl p-1.5 md:p-3 hover:bg-white/15 transition-all">
                  <div className="text-white flex-shrink-0 bg-white/20 rounded p-1 md:p-2 text-[12px] md:text-base">
                    {item.icon}
                  </div>
                  <div>
                    <h3 className="text-white font-bold text-[10px] md:text-sm leading-tight">{item.title}</h3>
                    <p className="text-blue-100 text-[8px] md:text-xs leading-tight hidden md:block">{item.desc}</p>
                  </div>
                </div>
              ))}
            </div>
